...
{
   textureName          = "~/data/Shared/particles/saturn";
   dragCoefficient      = 1;
...
{
   //shapeFile = "file";
   texture = "~data/Shared/particles/spark";
...
{
   textureName          = "~/data/Shared/particles/bubble";
   dragCoefficient      = 0;
   gravityCoefficient   = 0.0;
   windCoefficient      = 0;
   inheritedVelFactor   = 0.2;
...
function endFireWorks(%position)
{
   if (isObject(FireWorks))
      FireWorks.delete();
