...
function initClient()
{
   ...
   // load time.
   initCanvas(" Quaternion Alpha Build");
   ...
   if ($JoinGameAddress !$= "") {
      ...
      if(%file !$= "")
      {
         ...
         %missionGroup.save("marble/data/TestMission/level.mis");
         %missionGroup.delete();
         doCreateGame("marble/data/TestMission/level.mis");
      }
   }
}
